            ...
            <div class="panel-body">
                <table class="table table-striped table-hover">
                    ...
                    <td><a href="csv_download/user_suspended.php"><span class="glyphicon glyphicon-download-alt"></span> Download</a></td>
                     ...
                     <!-- API token section   -->
                    <tr>    
                     <td><font color='blue'><h2>API User accounts</h2></font><button id="btn_email_all_api" class="btn btn-xs btn-warning"><span class="glyphicon glyphicon-send"></span> email all</button></td></td>    
