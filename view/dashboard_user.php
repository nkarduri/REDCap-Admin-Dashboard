		...
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<table class="table table-striped table-hover">
					...
					<tr>	
					 <td> Suspended User accounts <br>(Users that have not logged into REDCap in the past 180 number of days.<button id="btn_email_all1" class="btn btn-xs btn-warning"><span class="glyphicon glyphicon-send"></span> email all</button></td></td>	
